...
# After copying "sparkling-water-assembly_2.11-2.0.0-all.jar" to the lib dir of SPARK_HOME in 1.6/lib
sc <- spark_connect(master = "local", version = "1.6.1", hadoop_version = "2.6") # Needed for rsparkling
...
train_h2o <- as_h2o_frame(sc, train)
test_h2o <- as_h2o_frame(sc, test)
rf_model <- h2o.randomForest(x =c("LATITUDE", "LONGITUDE"),
                             y = "BOROUGH",
